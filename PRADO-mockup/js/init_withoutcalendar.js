...
//
    ...
    $(window).bind("resize", function(){
     ...
     /*   var isIE = $.browser.msie == true;*/
        var tmpCurrentSlide = $('.flexslider.carousel').flexslider().data().flexslider.currentSlide;
        ...
        if (tmpCurrentSlide != 0) {
           ...
           //if NOT IE
           if (isIE != true) {
             var tmpFlexValue = $('.flexslider.carousel').flexslider(tmpCurrentSlide);
             if (tmpFlexValue == undefined) {
                $('.flexslider.carousel').flexslider(0);
             }
           }

           var tmpCurrentSlide = $('.flexslider.carousel').flexslider().data().flexslider.currentSlide;
           var tmpPages = $('.flexslider.carousel').flexslider().data().flexslider.pagingCount;
           ...
           if (isIE == true){
              if (tmpCurrentSlide >= tmpPages) {
                    $('.flexslider.carousel').flexslider(0); //this triggers another resize event
               }
           }
        }
    });
